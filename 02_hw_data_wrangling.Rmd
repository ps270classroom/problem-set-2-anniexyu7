...
knitr::kable(party_incumbent_promote, 
             digits = 3, 
             col.names = c("Party", "Incumbent Status", "Self-Promotion Ad Proportion"))
...
Most of the House candidates did not have more than 10 millino ad impressions on Facebook. 
...
fb_top_plot <- ggplot(data = top_candidates, aes(x = impressions_millions, y = cand_name_last, fill = party)) +
