...
```{r eval = FALSE}
knitr::kable(my_table, col.names = c("Party", "Incumbent Status", "Self-Promotion Ad Proportion))
```
...
ggplot(plot_q3, aes(x = impressions_millions)) +
...
fb_top_plot <- ggplot(data = fb_top_plot, 
                      aes(
